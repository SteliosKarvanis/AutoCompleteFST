...
public:
    ...
    std::vector<std::string> retrieve_words(std::string word, int max_num_of_results = 20);
...
private:
    ...
    // Search utils
    void DFS(Node* base_node, std::string word, std::vector<std::string>& output_words, int max_num_of_results);
